...
f=open("/home/oracle/scripts/adminurl.txt", "r")
if f.mode == 'r':
    adminurl = f.read()
...
def connectToDomain():
    try:
	   ...
	   connect(userConfigFile='/home/oracle/scripts/userconfig.secure', userKeyFile='/home/oracle/scripts/userkey.secure', url=(adminurl), timeout=60000)
